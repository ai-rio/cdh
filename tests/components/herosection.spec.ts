    ...
    return isOpen
      ? React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'form',
              { 'data-testid': 'early-access-form', onSubmit: handleSubmit },
              ...
              React.createElement('textarea', {
                placeholder: 'What challenges are you facing with data visibility?',
              }),
...
describe('HeroSection Integration Tests', () => {
  ...
  it('hero section displays correctly', () => {
    ...
    // Check main heading
    expect(screen.getByText('Your Creator Business, Under Command.')).toBeInTheDocument()
  ...
  it('Request Early Access button opens modal', async () => {
    ...
    expect(
      screen.getByPlaceholderText('What challenges are you facing with data visibility?'),
    ).toBeInTheDocument()
  })
  ...
  it('early access form submission works', async () => {
    ...
    const messageInput = screen.getByPlaceholderText(
      'What challenges are you facing with data visibility?',
    )
  ...
  it('hero section is accessible', () => {
    ...
    expect(heading).toHaveTextContent('Your Creator Business, Under Command.')
