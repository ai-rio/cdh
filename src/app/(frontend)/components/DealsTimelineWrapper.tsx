...
// Mock data for deals (same as original)
const mockDeals: Deal[] = [
  ...
  },
  {
    ...
    endDate: '2024-04-30',
    status: 'active',
    description: 'Workout equipment reviews and fitness content creation',
    deliverables: ['YouTube videos (4)', 'Instagram posts (8)', 'Product photos'],
    progress: 45
  },
  {
    id: '4',
    ...
    endDate: '2024-04-15',
    status: 'pending',
    description: 'Skincare routine content and product reviews',
    deliverables: ['Instagram Reels (6)', 'Stories (15)', 'Blog review'],
    progress: 0
  }
]

export default function DealsTimelineWrapper() {
