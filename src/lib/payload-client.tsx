...
class MockPayloadClient implements PayloadClient {
...
const PayloadContext = createContext<PayloadClient | null>(null);

export function PayloadProvider({ children }: { children: ReactNode }) {
  const client = new MockPayloadClient();
  
  return (
    <PayloadContext.Provider value={client}>
      {children}
    </PayloadContext.Provider>
  );
}

export function usePayload(): PayloadClient | null {
