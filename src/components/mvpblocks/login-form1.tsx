      ...
      <div className="w-full space-y-4 sm:max-w-md">
        <div className="text-center">
          ...
          <div className="mt-5 space-y-2">
            <h3 id="auth-modal-title" className="text-2xl font-bold sm:text-3xl">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                type="email"
                required
                className={`mt-2 w-full rounded-lg border bg-transparent px-3 py-2 shadow-sm outline-none ${emailError ? 'border-red-500' : 'focus:border-rose-600'}`}
                value={email}
                onChange={(e) => {
            ...
            <div className="relative">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className={`mt-2 w-full rounded-lg border bg-transparent px-3 py-2 shadow-sm outline-none ${passwordError ? 'border-red-500' : 'focus:border-rose-600'}`}
                  value={password}
                  onChange={(e) => {
            ...
            <button className="w-full rounded-lg bg-rose-600 px-4 py-2 font-medium text-white duration-150 hover:bg-rose-500 active:bg-rose-600" disabled={isSubmitting}>
