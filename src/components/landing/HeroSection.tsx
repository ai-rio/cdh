    ...
    <main className="relative h-screen flex flex-col justify-center items-center p-4 md:p-8">
      <div className="text-center">
        <Card className="bg-black/20 border-white/10 backdrop-blur-xl">
          ...
          {/* We apply the same flexbox logic here to center the content within the card */}
          <CardContent className="p-8 md:p-12 flex flex-col items-center gap-0 md:gap-0">
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-blue-300 text-center">
              From Burnout to Business Owner. The Creator-First Management Platform.
            </h1>
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl text-center">
              Stop wrestling with spreadsheets and chasing payments. Our AI Co-Pilot automates your
              brand deal management and clarifies your finances, so you can escape the admin
              nightmare and focus on creating.
            </p>
            <Button
              onClick={openModal}
